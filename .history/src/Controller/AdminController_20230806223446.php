...
class AdminController extends AbstractController
{
    ...
    #[Route('/admin/user/delete/{id}', name: 'admin_center_delete')]
    public function centerDelete(int $id, UserRepository $userRepository, EntityManagerInterface $entityManager): Response
    {
        $user = $userRepository->find($id);
