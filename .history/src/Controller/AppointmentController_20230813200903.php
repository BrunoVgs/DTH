...
class AppointmentController extends AbstractController
{
    ...
    public function index(Request $request): Response
    {
        if ($request->isMethod('POST')) {
            // Le formulaire a été soumis, On affiche la page de 
            // prise de rendez-vous avec les détails du centre sélectionné
        ...
        // Si le formulaire n'est pas soumis, On redirige l'utilisateur vers la page home
    ...
    {   
        // On récupere l'utilisateur actuellement authentifié
        $user = $security->getUser();
        // On récupere les données en les stockant dans des variables
        ...
        // On crée une instance de l'entité Appointment et on associe les données
        ...
        // On Redirige vers une page de confirmation ou la homepage
        return $this->redirectToRoute('home');
    }
