...
Avec cette approche, nous utilisons l'injection de dépendances pour obtenir l'EntityManager, et nous pouvons l'utiliser pour effectuer les opérations de suppression dans la base de données. Encore une fois, n'oubliez pas de définir la route admin_user_delete dans le fichier de routage (config/routes.yaml) pour relier cette action du contrôleur à l'URL souhaitée.
