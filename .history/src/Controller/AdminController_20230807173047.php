...
class AdminController extends AbstractController
{
    ...
    public function donations(DonationRepository $donationRepository): Response
    {
        ...
        /**
     * @Route("/admin/donation/{id}/edit", name="admin_donation_edit")
     */
    public function editDonation(EntityManagerInterface $entityManager, Request $request, int $id): Response
    {
        // Récupérer la donation à partir de l'identifiant $id
        ...
        $donorFirstName = $request->request->get('donor_first_name');
        $donorLastName = $request->request->get('donor_last_name');
        $collectionCenter = $request->request->get('collection_center');
