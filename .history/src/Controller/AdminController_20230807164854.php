...
class AdminController extends AbstractController
{
     ...
     */
    public function listAllMessages(EntityManagerInterface $entityManager, MessageRepository $messageRepository): Response
    {
        $messages = $messageRepository->findAll();

        return $this->redirectToRoute('admin/message.html.twig', [
            'messages' => $messages,
        ]);
    }
}
