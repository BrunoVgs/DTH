...
class DonationController extends AbstractController
{
    ...
    public function createDonation(Request $request, EntityManagerInterface $entityManager): JsonResponse
    {
        $data = json_decode($request->getContent(), true);
        dump($data);
        return new JsonResponse(['message' => 'Data received successfully'], JsonResponse::HTTP_OK);
