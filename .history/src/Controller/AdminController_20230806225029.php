...
class AdminController extends AbstractController
{
    ...
    #[Route('/admin/use Appuser', name: 'admin_user')]
    ...
    ): Response
    {
        ...
        if ($request->isMethod('POST')) {
            ...
            $lastname = $request->request->get('address');
            $email = $request->request->get('postalcode');
            $age = $request->request->get('city');
            $weight = $request->request->get('availableseats');
            $height = $request->request->get('height');
            $adress = $request->request->get('address');
            $postalcode = $request->request->get('postalcode');
            $city = $request->request->get('city');
