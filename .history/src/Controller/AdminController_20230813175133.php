...
class AdminController extends AbstractController
{
    ...
    #[Route('/admin/donations/{id}', name: 'admin_donations_edit')]
    public function donationEdit(int $id, DonationRepository $donationRepository, CollectionCenterRepository $centerRepository): Response
    {
        $donation = $donationRepository->find($id);
        $centers = $centerRepository->findAll();
        return $this->render('admin/donationsedit.html.twig', [
            'controller_name' => 'AdminController',
            'donation' => $donation,
            'centers' => $centers
    ...
    #[Route('/admin/donations/update/{id}', name: 'admin_donations_update')]
    public function donationsUpdate(
        int $id,
        Request $request,
        DonationRepository $donationRepository,
        EntityManagerInterface $entityManager
        ...
        if (!$donation) {
            throw $this->createNotFoundException('La donation avec l\'identifiant ' . $id . ' n\'existe pas.');
        }

        $donorFirstName = $request->request->get('donorFirstName');
        $donorLastName = $request->request->get('donorLastName');
        $collectionCenter = $request->request->get('collectioncenter');

        $donation->setDonorFirstName($donorFirstName);
        $donation->setDonorLastName($donorLastName);
        $donation->setCollectionCenter($collectionCenter);
    ...
    public function donationsDelete(int $id, DonationRepository $donationRepository, EntityManagerInterface $entityManager): Response
    {
        $donation = $donationRepository->find($id);
    ...
    #[Route('/admin/messageries', name: 'admin_messagerie')]
